  ...
  <form class="max-w-xs mx-auto">
    ...
    <div class="relative flex items-center">
      ...
      <input
          ...
          type="text"
          :value="qty"
          data-input-counter class="w-7 flex-shrink-0 text-gray-900 border-0 bg-transparent text-sm font-normal text-center" placeholder="" />
      <button
          @click="change(qty + 1)"
